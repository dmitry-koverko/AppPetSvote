...
class BesieTabLayout @JvmOverloads constructor(
    ...
    private fun animColor(view: SFTextView, isActive: Boolean){
        var color1 = ContextCompat.getColor(context, R.color.besie_tab_text_selected_color)
        var color2 = ContextCompat.getColor(context, R.color.besie_tab_text_unselected_color)
