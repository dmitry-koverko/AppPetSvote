...
public class CustomImageCropView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private CustomImageCropView.OnImageViewTouchDoubleTapListener mDoubleTapListener;
    private CustomImageCropView.OnImageViewTouchSingleTapListener mSingleTapListener;
    ...
    public CustomImageCropView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomImageCropView(Context context, AttributeSet attrs, int defStyle) {
...
//        }
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            return CustomImageCropView.this.onSingleTapConfirmed(e);
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            return CustomImageCropView.this.onScroll(e1, e2, distanceX, distanceY);
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            return CustomImageCropView.this.onFling(e1, e2, velocityX, velocityY);
        }

        @Override
        public boolean onSingleTapUp(MotionEvent e) {
            return CustomImageCropView.this.onSingleTapUp(e);
        }

        @Override
        public boolean onDown(MotionEvent e) {
            return CustomImageCropView.this.onDown(e);
        }
    }
