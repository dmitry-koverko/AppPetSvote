...
public class ScaleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private OnUpDownListener mOnUpDownListener = null;
    ...
    private ScaleImageView.OnImageViewTouchDoubleTapListener mDoubleTapListener;
    private ScaleImageView.OnImageViewTouchSingleTapListener mSingleTapListener;
...
//        }
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if(mOnUpDownListener != null) mOnUpDownListener.tap();
            if (null != mSingleTapListener) {
                mSingleTapListener.onSingleTapConfirmed();
            }

            return ScaleImageView.this.onSingleTapConfirmed(e);
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            return ScaleImageView.this.onScroll(e1, e2, distanceX, distanceY);
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            return ScaleImageView.this.onFling(e1, e2, velocityX, velocityY);
        }

        @Override
        public boolean onSingleTapUp(MotionEvent e) {
            return ScaleImageView.this.onSingleTapUp(e);
        }

        @Override
        public boolean onDown(MotionEvent e) {
            return ScaleImageView.this.onDown(e);
        }
    }
    ...
    public class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector detector) {
            if(mOnUpDownListener != null) mOnUpDownListener.down();
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            ...
            if(mOnUpDownListener != null) mOnUpDownListener.up();
