...
class GetKindsUseCase @Inject constructor(
    ...
    override suspend fun getKinds(): List<Kind> = withContext(Dispatchers.IO){
        ...
        return@withContext listOf<Kind>(
            Kind(0, resourcesRepository.getString(R.string.cats), "cat", 30, checkSelected(array, "cat")),
            Kind(1, resourcesRepository.getString(R.string.dogs), "dog", 30, checkSelected(array, "dog")),
            Kind(2, resourcesRepository.getString(R.string.horses), "horse", 45, checkSelected(array, "horse")),
            Kind(3, resourcesRepository.getString(R.string.ferrets), "ferret", 15, checkSelected(array, "ferret")),
            Kind(4, resourcesRepository.getString(R.string.reptiles), "reptile", 200, checkSelected(array, "reptile")),
            Kind(5, resourcesRepository.getString(R.string.rodents), "rodent", 20, checkSelected(array, "rodent")),
            Kind(6, resourcesRepository.getString(R.string.amphibians), "amphibian", 30, checkSelected(array, "amphibian")),
            Kind(7, resourcesRepository.getString(R.string.birds), "bird", 90, checkSelected(array, "bird")),
            Kind(8, resourcesRepository.getString(R.string.exotics), "exotic", 60, checkSelected(array, "exotic")),
            ...
            Kind(11, resourcesRepository.getString(R.string.robots), "robots", 999, checkSelected(array, "robots")),
        )
    }
